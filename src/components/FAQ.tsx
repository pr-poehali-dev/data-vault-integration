...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Работаем с массивом дуба, ясеня, бука и сосны, а также с качественной мебельной плитой для отдельных элементов. Используем проверенную фурнитуру и безопасные масла и лаки для покрытия. Конкретный материал подбираем под ваш бюджет и задачу.",
  },
  {
